namespace ToDoList
{
    partial class ProgramInformationBox
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 46.5827332F));
            tableLayoutPanel.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 53.4172668F));
            ...
            logoPictureBox.Image = Properties.Resources.about_icon_bigger;
            logoPictureBox.Location = new Point(4, 5);
            logoPictureBox.Margin = new Padding(4, 5, 4, 5);
            logoPictureBox.Name = "logoPictureBox";
            tableLayoutPanel.SetRowSpan(logoPictureBox, 6);
            logoPictureBox.Size = new Size(251, 397);
            ...
            textBoxDescription.Location = new Point(267, 165);
            textBoxDescription.Margin = new Padding(8, 5, 4, 5);
            textBoxDescription.Multiline = true;
            textBoxDescription.Name = "textBoxDescription";
            textBoxDescription.ReadOnly = true;
            textBoxDescription.ScrollBars = ScrollBars.Both;
            textBoxDescription.Size = new Size(285, 193);
